...
Mesh::Mesh(UINT32 size, void* data, UINT32 itemSize, UINT32 indexSize, UINT32* indices, Shader* pShader, Material* material) :
	m_Shader(pShader), m_Material(material), m_ItemSize(itemSize) {
